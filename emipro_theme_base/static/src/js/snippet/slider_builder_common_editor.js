    ...
    publicWidget.registry.sliderEditorCommonEpt = publicWidget.Widget.extend(OwlMixin, {
        ...
        showPopup: function() {
            ...
            ajax.jsonRpc('/get-slider-builder-popup', 'call', {
                ...
                $('#product_configure_model .configure-sub-header .configure-selection.js-configuration-selection').addClass('active');
                $('#product_configure_model .configure-sub-header .configure-selection.js-layout-selection').removeClass('active');
                name = name === 'product-slider' ? $('.product_configure_model .product-config-content').first().attr('data-value') : name
