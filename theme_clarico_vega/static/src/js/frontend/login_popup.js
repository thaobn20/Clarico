            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data_main.login_success && data_main.redirect) {
                        ...
                        $("#loginRegisterPopup .oe_login_form .oe_login_buttons .te_login_button").removeAttr('disabled');
                        $("#loginRegisterPopup .oe_login_form .oe_login_buttons .te_login_button .fa-spin").removeClass('fa-refresh fa-spin');
                    }
                },
                error: function(data) {
